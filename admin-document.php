		...
		<div class="kboard-document-wrap" itemscope itemtype="http://schema.org/Article">
			...
			<div class="kboard-content" itemprop="description">
				<div class="content-view">
					...
					<p>
						<?php echo ($content->member_display) ? '이름 : '.$content->member_display.'<br>' : ''; ?>
						<?php echo ($content->option->email) ? '이메일 : '.$content->option->email.'<br>' : ''; ?>
						<?php echo ($content->option->tel) ? '연락처 : '.$content->option->tel.'<br>' : ''; ?>
					</p>
					<?php endif?>
